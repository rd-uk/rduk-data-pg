...
## 0.2.1 - 2018-05-24
### Changed
- update dev dependency `coveralls` to latest version ([3.0.1](https://github.com/nickmerwin/node-coveralls/releases/tag/3.0.1))
- update dev dependency `jasmine` to latest version ([3.1.0](https://github.com/jasmine/jasmine-npm/releases/tag/v3.1.0))
- update dev dependency `pg` to latest version ([7.4.3](https://github.com/brianc/node-postgres/releases/tag/v7.4.3))
- update dev dependency `standard` to latest version ([11.0.1](https://github.com/standard/standard/releases/tag/v11.0.1))
